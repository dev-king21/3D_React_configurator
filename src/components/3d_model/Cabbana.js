...
export function Model(props) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      {props.activeStep === 1 && props.subStep === 0 ? <Html scaleFactor={5} position={[0, 0, snap.length.depth / 2]}>
          <div className="length-info">{snap.length.depth}mm</div>
      </Html>:null}
      {props.activeStep === 1 && props.subStep === 0 ? <Html scaleFactor={5} position={[snap.length.width / 2, 0, snap.length.depth]}>
          <div className="length-info">{snap.length.width}mm</div>
      </Html>:null}
      {props.activeStep ===1 && props.subStep === 0 ? <Html scaleFactor={5} position={[0, snap.length.height / 2, snap.length.depth]}>
          <div className="length-info">{snap.length.height}mm</div>
      </Html>:null}


      {props.activeStep === 1 && props.subStep === 1 ? <Html scaleFactor={5} position={[snap.columns.pos[3], 0, snap.length.depth * 3/ 2]}>
          <div className="length-info">D</div>
      </Html>:null}
      {props.activeStep === 1 && props.subStep === 1 ? <Html scaleFactor={5} position={[snap.length.width - snap.columns.pos[2], 0, snap.length.depth * 3/ 2]}>
          <div className="length-info">C</div>
      </Html>:null}
      {props.activeStep === 1 && props.subStep === 1 ? <Html scaleFactor={5} position={[snap.length.width - snap.columns.pos[1], snap.length.height, snap.length.depth * 3/ 2]}>
          <div className="length-info">B</div>
      </Html>:null}
      {props.activeStep === 1 && props.subStep === 1 ? <Html scaleFactor={5} position={[snap.columns.pos[0], snap.length.height, snap.length.depth * 3/ 2]}>
          <div className="length-info">A</div>
      </Html>:null}

      {props.activeStep === 1 && props.subStep === 1 && snap.columns.added[6]? <Html scaleFactor={5} position={[snap.columns.pos[6], 0, snap.length.depth * 3/ 2]}>
          <div className="length-info">G</div>
      </Html>:null}
      {props.activeStep === 1 && props.subStep === 1 && snap.columns.added[5]? <Html scaleFactor={5} position={[snap.length.width, snap.length.height - snap.columns.pos[5] + lengths.thickness, snap.length.depth * 3/ 2]}>
          <div className="length-info">F</div>
      </Html>:null}
      {props.activeStep === 1 && props.subStep === 1 && snap.columns.added[7]? <Html scaleFactor={5} position={[0, snap.length.height - snap.columns.pos[7] + lengths.thickness, snap.length.depth * 3/ 2]}>
          <div className="length-info">H</div>
      </Html>:null}
      {props.activeStep === 1 && props.subStep === 1 && snap.columns.added[4]? <Html scaleFactor={5} position={[snap.columns.pos[4], snap.length.height, snap.length.depth * 3/ 2]}>
          <div className="length-info">E</div>
      </Html>:null}



      {props.activeStep === 1 && props.subStep === 1 && snap.columns.adding === true? <Html scaleFactor={5} position={[snap.length.width / 2, snap.length.height, 0]}>
          <div
            className="side-info"
      ...
      {props.activeStep === 1 && props.subStep === 1 && snap.columns.adding === true? <Html scaleFactor={5} position={[snap.length.width, snap.length.height / 2, 0]}>
          <div
            className="side-info"
      ...
      {props.activeStep === 1 && props.subStep === 1 && snap.columns.adding === true? <Html scaleFactor={5} position={[snap.length.width / 2, 0, 0]}>
          <div
            className="side-info"
      ...
      {props.activeStep === 1 && props.subStep === 1 && snap.columns.adding === true? <Html scaleFactor={5} position={[0, snap.length.height / 2, 0]}>
          <div
            className="side-info"
